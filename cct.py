...
def xyz_to_cct_search(data, cieobs = _cieobs, out = 'cct',wl = None, accuracy = 0.1, upper_cct_max = 10.0**20, approx_cct_temp = False):
    """
...
def xyz_to_cct_ohno(data, cieobs = _cieobs, out = 'cct', wl = None, accuracy = 0.1, force_out_of_lut = True, upper_cct_max = 10.0**20, approx_cct_temp = False):
    """
    Convert data = np.array([[x,y,z]]) tristimlus values to cct (correlated color temperature)
...
#---------------------------------------------------------------------------------------------------
def cct_to_xyz(data, duv = None, cieobs = _cieobs, wl = None, mode = 'lut', out = None, accuracy = 0.1, force_out_of_lut = True, upper_cct_max = 10.0*20, approx_cct_temp = False):
    """
...
def xyz_to_cct(data, cieobs = _cieobs, out = 'cct',mode = 'lut', wl = None,accuracy = 0.1, force_out_of_lut = True, upper_cct_max = 10.0**20,approx_cct_temp = False):
    """
    Convert data = np.array([[x,y,z]]) tristimlus values to cct (correlated color temperature)
...
def xyz_to_duv(data, cieobs = _cieobs, out = 'duv',mode = 'lut', wl = None,accuracy = 0.1, force_out_of_lut = True, upper_cct_max = 10.0**20,approx_cct_temp = False):
    """
